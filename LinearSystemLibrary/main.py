...
if __name__ == "__main__":
    ...
    if debug:
        ...
        for i in range(len(matrices)):
            ...
            plt.yticks([])
            if i == 0:
                plt.savefig('./imgs/matrice_sparsa_spa1.png', format='png')
            if i == 1:
                plt.savefig('./imgs/matrice_sparsa_spa2.png', format='png')
            if i == 2:
                plt.savefig('./imgs/matrice_sparsa_vem1.png', format='png')
            if i == 3:
                plt.savefig('./imgs/matrice_sparsa_vem2.png', format='png')
